...
import { incrementLetterSchema } from "../_components/certificate-types";
import type { IncrementLetterData } from "../_components/certificate-types";
import { CommonFormFields } from "../_components/common-form-fields";
import { IncrementFormFields } from "../_components/increment-form-fields";
...
export default function IncrementLetterPage() {
  ...
  const form = useForm<IncrementLetterData>({
    resolver: zodResolver(incrementLetterSchema) as any,
    defaultValues: {
      ...
      certificateTitle: "Increment Letter",
      fontFamily: "Outfit",
      fontSize: "medium",
      textColor: "#000000",
      lineSpacing: "1.5",
      ...
      effectiveDate: "",
      reason: `<p>Dear <strong>[Mr./Ms. Full Name]</strong>,</p><p>We are pleased to inform you that your salary has been revised effective from <strong>[Effective Date]</strong>. This revision is based on your performance and contribution to the institution.</p><p>Your previous salary was <strong>[Previous Salary]</strong>, and your new salary will be <strong>[New Salary]</strong>. This means an increment of <strong>[Increment Amount]</strong> (<strong>[Increment Percentage]</strong>).</p><p>We appreciate your dedication and hard work.</p>`,
    },
  });
  ...
  return (
    <div className="container mx-auto p-3 sm:p-6 space-y-6 sm:space-y-10 max-w-7xl pb-8">
        ...
        <div className="flex items-center gap-3 sm:gap-4">
          ...
          <div>
            ...
            <p className="text-sm sm:text-lg text-muted-foreground mt-1 font-medium leading-relaxed">
              Generate and customize professional increment letters.
            </p>
          </div>
        </div>
      </div>
                ...
                <div className="max-h-[60vh] lg:max-h-[75vh] overflow-y-auto overflow-x-hidden custom-scrollbar bg-slate-50/50">
                  <div className="p-4 sm:p-6 lg:p-4 flex justify-center">
                    <div className="origin-top scale-[0.5] sm:scale-[0.7] md:scale-[0.8] lg:scale-[1.0] transition-transform duration-500 ease-out w-[200%] sm:w-[143%] md:w-[125%] lg:w-full">
                      <CertificatePreview data={formData} type="increment" />
                    </div>
                  </div>
                </div>
              </div>
      ...
      <div style={{ position: "absolute", left: "-9999px", top: 0 }}>
        <div ref={printRef}>
          <CertificatePreview data={formData} type="increment" isPrint={true} />
        </div>
      </div>
    </div>
  );
