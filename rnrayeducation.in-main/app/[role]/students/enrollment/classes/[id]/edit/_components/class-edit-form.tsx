...
import { X, Plus, Loader2, ArrowLeft, Check } from "lucide-react";
...
export function ClassEditForm() {
  ...
  useEffect(() => {
    if (classData) {
      form.reset({
        ...
        capacityPerSection: classData.capacityPerSection,
  ...
  const onSubmit = async (data: ClassFormData) => {
    ...
    try {
      ...
      router.push(`/${role}/students/enrollment/classes/${classId}`);
    } catch (error) {
              ...
              render={() => (
                <FormItem>
                  ...
                  <div className="space-y-2">
                    ...
                    <FormDescription>
                      Add or remove sections for this class. At least one
                      section is required.
                    </FormDescription>
                    <FormMessage />
                  </div>
